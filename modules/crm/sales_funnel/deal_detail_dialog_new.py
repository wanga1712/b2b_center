"""
MODULE: modules.crm.sales_funnel.deal_detail_dialog_new
RESPONSIBILITY: New Detailed Deal Card Dialog implementation.
ALLOWED: PyQt5, loguru, modules.crm.sales_funnel.deal_detail_logic, modules.crm.sales_funnel.deal_detail_ui.
FORBIDDEN: Mixing UI setup with business logic (use handlers).
ERRORS: None.
